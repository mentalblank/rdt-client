...
public abstract class UsenetBaseProcessor
{
    public class Result;
    ...
    public virtual async Task<Result?> ProcessAsync(IProgress<Int32> progress)
    {
        try
        {
...
public class UsenetRarProcessor(
...
) : UsenetBaseProcessor
{
    public override async Task<UsenetBaseProcessor.Result?> ProcessAsync()
    {
        ...
        var headers = await UsenetRarUtil.GetRarHeadersAsync(stream, password, ct).ConfigureAwait(false);
    ...
    private static Int32? GetPartNumberFromHeaders(List<IRarHeader> headers)
    {
    ...
    public class StoredFileSegment
    {
        ...
        public required Int64 PartSize { get; init; }
        ...
        public required Int64 FileUncompressedSize { get; init; }
    }

    public record PartNumber
    {
        public Int32? PartNumberFromHeader { get; init; }
        public Int32? PartNumberFromFilename { get; init; }
    }
}
