...
public class DbSettingsDefaults
{
    ...
    [DisplayName("[Symlink Only] Download compressed files from debrid provider")]
    [Description("When selected an using symlink downloader, it will allow the download of compressed files from your debrid provider.")]
