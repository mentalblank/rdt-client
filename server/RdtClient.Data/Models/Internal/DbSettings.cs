...
public class DbSettingsUsenet
{
    ...
    [Description("Path where the Usenet symlinks are created on your host (i.e. D:\\Usenet). This path is used for *arr to find your downloads.")]
    public String MappedPath { get; set; } = "";

    [DisplayName("WebDAV Rclone mount path")]
    [Description("The path where the WebDAV server is mounted via rclone (e.g. /mnt/rclone/usenet).")]
    public String RcloneMountPath { get; set; } = "";

    [DisplayName("Symlink path")]
    [Description("The path where symlinks should be created (e.g. /mnt/symlinks/usenet).")]
...
public class DbSettingsGeneral
{
    ...
    public String? Categories { get; set; } = "radarr,sonarr,manual,sonarr-anime,radarr-anime,TEST";
...
<a href=""https://github.com/rogerfar/rdt-client/"" target=""_blank"">README</a> for the various options.")]
    ...
    public String DownloadPath { get; set; } = "/mnt/symlinks/RealDebrid";
    ...
    public String MappedPath { get; set; } = "/mnt/symlinks/RealDebrid";
