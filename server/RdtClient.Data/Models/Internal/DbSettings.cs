...
%I: Info hash")]
    ...
    [Description("[Only with Symlink Downloader] When a torrent file is added, keep a copy in MappedPath/TorrentBlackhole/ImportCategory directory.")]
    public Boolean KeepCopyAddedTorrents { get; set; } = false;

    [DisplayName("RClone refresh command for sped up file discovery")]
...
public class DbSettingsDefaults
{
    ...
    [Description("When selected, it will only download files in the torrent that have been download by the provider. You can use this in combination with the Min File size setting above.")]
    ...
    public String? ExcludeRegex { get; set; } = @"(?:\.xml|\.ac3|\.bat|\.bmp|\.cmd|\.cue|\.db|\.diz|\.dll|\.((dvd)?disc|par(t)?|py)([0-9]|\b)|\.exe|\.flac|\.gif|\.htm(l)?|\.ico(n)?|\.idx|\.info|\.ini|\.index|\.jp(e)?g|\.l(i)?nk|\.md5|\.m2ts|\.mp3|\.nfo|\.nzb|\.png|\.rar|\.readme|\.reg|\.sample|\.sfv|\.sql|\.srr|\.sub|\.srt|\.tag|\.tak|\.t(e)?xt|\.thumb|\.torrent|\.ts|\.url|\.vbs|\.webp|\.zip|\.zsh|padding_file|small\.file|_unpack|\.ade|\.adp|\.app|\.application|\.appref-ms|\.asp|\.aspx|\.asx|\.bas|\.bgi|\.cab|\.cer|\.chm|\.cmd|\.cnt|\.com|\.cpl|\.crt|\.csh|\.der|\.diagcab|\.fxp|\.gadget|\.grp|\.hlp|\.hpj|\.hta|\.htc|\.inf|\.ins|\.iso|\.isp|\.its|\.jar|\.jnlp|\.js|\.jse|\.ksh|\.lnk|\.mad|\.maf|\.mag|\.mam|\.maq|\.mar|\.mas|\.mat|\.mau|\.mav|\.maw|\.mcf|\.mda|\.mdb|\.mde|\.mdt|\.mdw|\.mdz|\.msc|\.msh|\.msh1|\.msh2|\.mshxml|\.msh1xml|\.msh2xml|\.msi|\.msp|\.mst|\.msu|\.ops|\.osd|\.pcd|\.pif|\.pl|\.plg|\.prf|\.prg|\.printerexport|\.ps1|\.ps1xml|\.ps2|\.ps2xml|\.psc1|\.psc2|\.psd1|\.psdm1|\.pst|\.py|\.pyc|\.pyo|\.pyw|\.pyz|\.pyzw|\.reg|\.scf|\.scr|\.sct|\.shb|\.shs|\.theme|\.tmp|\.vb|\.vbe|\.vbp|\.vbs|\.vhd|\.vhdx|\.vsmacros|\.vsw|\.webpnp|\.website|\.ws|\.wsc|\.wsf|\.wsh|\.xbap|\.xll|\.xnk|\.7z|\.bdjo|\.bdmv|\.bin|\.cci|\.clpi|\.crl|\.html|\.idx|\.jpeg|\.jpg|\.m4a|\.mpls|\.msi|\.pdf|\.sig|\.tbl|\.txt|\.xig|\.xrt|\.zipx)(?![\w])";
