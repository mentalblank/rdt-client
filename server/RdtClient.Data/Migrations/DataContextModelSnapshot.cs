...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetDavItem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<DateTimeOffset?>("NextHealthCheck")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetHealthCheckResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("UsenetHealthCheckResults");
                });

            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetHealthCheckStat", b =>
                {
                    b.Property<DateTimeOffset>("DateStartInclusive")
                        .HasColumnType("TEXT");

                    b.Property<DateTimeOffset>("DateEndExclusive")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("UsenetHealthCheckStats");
                });
            ...
            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetMultipartFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("UsenetMultipartFiles");
                });

            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetNzbFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetRarFile", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetDavItem", b =>
                {
                    b.HasOne("RdtClient.Data.Models.Data.UsenetDavItem", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetMultipartFile", b =>
                {
                    b.HasOne("RdtClient.Data.Models.Data.UsenetDavItem", "DavItem")
                        .WithOne()
                        .HasForeignKey("RdtClient.Data.Models.Data.UsenetMultipartFile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetNzbFile", b =>
                {
                    b.HasOne("RdtClient.Data.Models.Data.UsenetDavItem", "DavItem")
                        .WithOne()
                        .HasForeignKey("RdtClient.Data.Models.Data.UsenetNzbFile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("RdtClient.Data.Models.Data.UsenetRarFile", b =>
                {
                    b.HasOne("RdtClient.Data.Models.Data.UsenetDavItem", "DavItem")
                        .WithOne()
                        .HasForeignKey("RdtClient.Data.Models.Data.UsenetRarFile", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
